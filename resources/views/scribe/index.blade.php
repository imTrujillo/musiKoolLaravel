        ...
        <div id="toc">
            ...
            <ul id="tocify-header-favoritos" class="tocify-header">
                ...
                <ul id="tocify-subheader-favoritos" class="tocify-subheader">
                    ...
                    <li class="tocify-item level-2" data-unique="favoritos-DELETEapi-users--user_id--favorites--id-">
                        <a href="#favoritos-DELETEapi-users--user_id--favorites--id-">Desmarcar un item de
                            favoritos.</a>
                    </li>
                </ul>
            </ul>
            <ul id="tocify-header-notas-musicales" class="tocify-header">
                ...
                <ul id="tocify-subheader-notas-musicales" class="tocify-subheader">
                    <li class="tocify-item level-2"
                        data-unique="notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes">
                        <a href="#notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes">Mostrar
                            notas musicales.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="notas-musicales-POSTapi-songs--song_id--compasses--compass_id--musicalNotes">
                        <a href="#notas-musicales-POSTapi-songs--song_id--compasses--compass_id--musicalNotes">Añadir
                            un nueva nota musical.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-">
                        <a href="#notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Mostrar
                            una nota musical.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="notas-musicales-PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-">
                        <a href="#notas-musicales-PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Actualizar
                            una nota.</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="notas-musicales-DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-">
                        <a href="#notas-musicales-DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Eliminar
                            una nota musical.</a>
                    </li>
                </ul>
            </ul>
            <ul id="tocify-header-resenas-de-canciones" class="tocify-header">
                ...
                <ul id="tocify-subheader-resenas-de-canciones" class="tocify-subheader">
                    <li class="tocify-item level-2"
                        data-unique="resenas-de-canciones-POSTapi-songs--song_id--reviews">
                        <a href="#resenas-de-canciones-POSTapi-songs--song_id--reviews">Guardar una reseña</a>
                    </li>
                    <li class="tocify-item level-2"
                        data-unique="resenas-de-canciones-PUTapi-songs--song_id--reviews--id-">
    ...
    <div class="page-wrapper">
        ...
        <div class="content">
            ...
            <p><img src="/logo.png" /><br>
                Nuestro proyecto de programación &quot;musiKool&quot;, es una aplicación educativa donde puedes
                registrarte como artista y guardar tus canciones. <br>
                Básicamente, es una biblioteca de canciones, artistas y acordes. Está orientada a fines didácticos, en
                especial, al aprendizaje del piano o la guitarra, mediante diagramas y muestras de sonido. <br>
    ...
    &quot;meta&quot;: {
        ...
        &quot;total&quot;: 270
            ...
            <span id="execution-results-GETapi-chords" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-chords"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-chords" data-method="GET" data-path="api/chords" data-authed="0"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        id="btn-tryout-GETapi-chords" onclick="tryItOut('GETapi-chords');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-chords" onclick="cancelTryOut('GETapi-chords');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-chords" data-initial-text="Send Request 💥"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-chords"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-chords"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-users" data-method="POST" data-path="api/users" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="POSTapi-users" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-users"
                        value="vmqeopfuudtdsufvy" data-component="body">
                    <br>
                    <p>Must be at least 5 characters. Must not be greater than 20 characters. Example:
                        <code>vmqeopfuudtdsufvy</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="password" data-endpoint="POSTapi-users"
                        value="OP>@;4" data-component="body">
                    <br>
                    <p>Must match the regex /[a-z]/. Must match the regex /[A-Z]/. Must match the regex /[0-9]/. Must be
                        at least 8 characters. Example: <code>OP&gt;@;4</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    <b style="line-height: 2;"><code>color</code></b>&nbsp;&nbsp;
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="color" data-endpoint="POSTapi-users"
                        value="#:4AB" data-component="body">
                    <br>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-PUTapi-users--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-users--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-users--id-" data-method="PUT" data-path="api/users/{id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PUTapi-users--id-" onclick="tryItOut('PUTapi-users--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-PUTapi-users--id-" onclick="cancelTryOut('PUTapi-users--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-users--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="PUTapi-users--id-" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-users--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-users--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="PUTapi-users--id-" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="PUTapi-users--id-"
                        value="vmqeopfuudtdsufvy" data-component="body">
                    <br>
                    <p>Must be at least 5 characters. Must not be greater than 20 characters. Example:
                        <code>vmqeopfuudtdsufvy</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="email" data-endpoint="PUTapi-users--id-"
                        value="dcarter@example.org" data-component="body">
                    <br>
                    <p>Must be a valid email address. Must not be greater than 255 characters. Example:
                        <code>dcarter@example.org</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="password" data-endpoint="PUTapi-users--id-"
                        value="OP>@;4" data-component="body">
                    <br>
                    <p>Must match the regex /[a-z]/. Must match the regex /[A-Z]/. Must match the regex /[0-9]/. Must be
                        at least 8 characters. Example: <code>OP&gt;@;4</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="color" data-endpoint="PUTapi-users--id-"
                        value="#:4AB" data-component="body">
                    <br>
                    <p>Must match the regex /^#(?:[0-9a-fA-F]{3}){1,2}$/. Example: <code>#:4AB</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-users--id-" data-method="DELETE" data-path="api/users/{id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-users--id-" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-users--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-users" data-method="GET" data-path="api/users" data-authed="0" data-hasfiles="0"
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-auth" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-auth"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-auth" data-method="POST" data-path="api/auth" data-authed="0" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-auth" onclick="tryItOut('POSTapi-auth');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-auth" onclick="cancelTryOut('POSTapi-auth');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-auth" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="POSTapi-auth"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-auth"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="email" data-endpoint="POSTapi-auth"
                        value="qkunze@example.com" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="password" data-endpoint="POSTapi-auth"
...
fetch(url, {
    ...
    headers,
            ...
            <span id="execution-results-DELETEapi-auth" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-auth"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-auth" data-method="DELETE" data-path="api/auth" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-DELETEapi-auth" onclick="tryItOut('DELETEapi-auth');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-DELETEapi-auth" onclick="cancelTryOut('DELETEapi-auth');" hidden>Cancel
                        🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-auth" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-auth" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="DELETEapi-auth"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="DELETEapi-auth"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-auth-register" data-method="POST" data-path="api/auth/register" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-auth-register" onclick="tryItOut('POSTapi-auth-register');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-auth-register" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-auth-register"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="name" data-endpoint="POSTapi-auth-register"
                        value="vmqeopfuudtdsufvyvddq" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="email" data-endpoint="POSTapi-auth-register"
                        value="kunde.eloisa@example.com" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <input type="text" style="display: none" name="password"
                        data-endpoint="POSTapi-auth-register" value="4[*UyPJ"}6" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="color" data-endpoint="POSTapi-auth-register"
                        value="#4CD4ab" data-component="body">
                    <br>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Necesitas un token&quot;
            ...
            <span id="execution-results-GETapi-token" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-token"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-token" data-method="GET" data-path="api/token" data-authed="0" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-token" onclick="tryItOut('GETapi-token');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-token" onclick="cancelTryOut('GETapi-token');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-token" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-token"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-token"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-POSTapi-songs" hidden>
                <blockquote>Received response<span id="execution-response-status-POSTapi-songs"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-songs" data-method="POST" data-path="api/songs" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-POSTapi-songs" onclick="tryItOut('POSTapi-songs');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-POSTapi-songs" onclick="cancelTryOut('POSTapi-songs');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-songs" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="POSTapi-songs" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-songs" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="POSTapi-songs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="title" data-endpoint="POSTapi-songs"
                        value="vmqeopfuudtdsufvy" data-component="body">
                    <br>
                    <p>Must be at least 5 characters. Must not be greater than 20 characters. Example:
                        <code>vmqeopfuudtdsufvy</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="bpm"
                        data-endpoint="POSTapi-songs" value="21" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="POSTapi-songs" value="17" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_scale_id"
                        data-endpoint="POSTapi-songs" value="17" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_metric_id"
                        data-endpoint="POSTapi-songs" value="17" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="musical_genre_id"
                        data-endpoint="POSTapi-songs" value="17" data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the musical_genres table. Example: <code>17</code>
                    </p>
                </div>
            </form>
...
fetch(url, {
    ...
    body: JSON.stringify(body),
            ...
            <span id="execution-results-PUTapi-songs--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-PUTapi-songs--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-songs--id-" data-method="PUT" data-path="api/songs/{id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-PUTapi-songs--id-" onclick="tryItOut('PUTapi-songs--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-PUTapi-songs--id-" onclick="cancelTryOut('PUTapi-songs--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-PUTapi-songs--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="PUTapi-songs--id-" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-songs--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="PUTapi-songs--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="PUTapi-songs--id-" value="1" data-component="url">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="title" data-endpoint="PUTapi-songs--id-"
                        value="vmqeopfuudtdsufvy" data-component="body">
                    <br>
                    <p>Must be at least 5 characters. Must not be greater than 20 characters. Example:
                        <code>vmqeopfuudtdsufvy</code></p>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="bpm"
                        data-endpoint="PUTapi-songs--id-" value="21" data-component="body">
                    <br>
                    <p>Must be at least 30. Must not be greater than 280. Example: <code>21</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="PUTapi-songs--id-" value="17" data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the users table. Example: <code>17</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
fetch(url, {
    ...
    headers,
            ...
            <span id="execution-results-DELETEapi-songs--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-DELETEapi-songs--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-songs--id-" data-method="DELETE" data-path="api/songs/{id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-DELETEapi-songs--id-" onclick="tryItOut('DELETEapi-songs--id-');">Try it out
                        ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-DELETEapi-songs--id-" onclick="cancelTryOut('DELETEapi-songs--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-DELETEapi-songs--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-songs--id-" value="Bearer {YOUR_AUTH_KEY}"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-songs--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="DELETEapi-songs--id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
            </form>
...
<code class="language-json" style="max-height: 300px;">{
    &quot;message&quot;: &quot;Unauthenticated.&quot;
            ...
            <span id="execution-results-GETapi-my-songs" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-my-songs"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-my-songs" data-method="GET" data-path="api/my-songs" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-my-songs" onclick="tryItOut('GETapi-my-songs');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-my-songs" onclick="cancelTryOut('GETapi-my-songs');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-my-songs" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="GETapi-my-songs" value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-my-songs" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-my-songs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
    ...
    &quot;meta&quot;: {
        ...
        &quot;total&quot;: 10
            ...
            <span id="execution-results-GETapi-songs" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-songs"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-songs" data-method="GET" data-path="api/songs" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-songs" onclick="tryItOut('GETapi-songs');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-songs" onclick="cancelTryOut('GETapi-songs');" hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-songs" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type" data-endpoint="GETapi-songs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-songs"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
    ...
    &quot;data&quot;: {
        ...
        &quot;chords&quot;: [
            ...
            <span id="execution-results-GETapi-songs--id-" hidden>
                <blockquote>Received response<span id="execution-response-status-GETapi-songs--id-"></span>:
                </blockquote>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-songs--id-" data-method="GET" data-path="api/songs/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-tryout-GETapi-songs--id-" onclick="tryItOut('GETapi-songs--id-');">Try it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-songs--id-" onclick="cancelTryOut('GETapi-songs--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-songs--id-" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-songs--id-" value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="Accept" data-endpoint="GETapi-songs--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="id"
                        data-endpoint="GETapi-songs--id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
            </form>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-songs--song_id--compasses" data-method="POST"
                data-path="api/songs/{song_id}/compasses" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-songs--song_id--compasses" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="POSTapi-songs--song_id--compasses" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-songs--song_id--compasses" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="POSTapi-songs--song_id--compasses" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
            </form>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-songs--song_id--compasses--id-" data-method="PUT"
                data-path="api/songs/{song_id}/compasses/{id}" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="PUTapi-songs--song_id--compasses--id-" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-songs--song_id--compasses--id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="PUTapi-songs--song_id--compasses--id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="order"
                        data-endpoint="PUTapi-songs--song_id--compasses--id-" value="73"
                        data-component="body">
                    <br>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-songs--song_id--compasses--id-" data-method="DELETE"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-songs--song_id--compasses--id-" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-songs--song_id--compasses--id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="DELETEapi-songs--song_id--compasses--id-" value="1"
                        data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-users--user_id--favorites" data-method="GET"
                data-path="api/users/{user_id}/favorites" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-GETapi-users--user_id--favorites" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="GETapi-users--user_id--favorites" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-users--user_id--favorites" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="GETapi-users--user_id--favorites" value="1" data-component="url">
                    <br>
                    <p>The ID of the user. Example: <code>1</code></p>
                </div>
            </form>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-users--user_id--favorites" data-method="POST"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-users--user_id--favorites" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="POSTapi-users--user_id--favorites" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-users--user_id--favorites" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="POSTapi-users--user_id--favorites" value="1" data-component="url">
                    <br>
                    <p>The ID of the user. Example: <code>1</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    &nbsp;
                    <input type="text" style="display: none" name="model"
                        data-endpoint="POSTapi-users--user_id--favorites" value="User" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="favoritable_id"
                        data-endpoint="POSTapi-users--user_id--favorites" value="73" data-component="body">
                    <br>
                    <p>Must be at least 1. Example: <code>73</code></p>
                </div>
            </form>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-DELETEapi-users--user_id--favorites--id-" data-method="DELETE"
                data-path="api/users/{user_id}/favorites/{id}" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-users--user_id--favorites--id-" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="DELETEapi-users--user_id--favorites--id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="DELETEapi-users--user_id--favorites--id-" value="1"
                        data-component="url">
                    <br>
                    <p>The ID of the user. Example: <code>1</code></p>
                </div>
            ...
            <h2 id="notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes">Mostrar notas
                musicales.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-songs--song_id--compasses--compass_id--musicalNotes" data-method="GET"
                data-path="api/songs/{song_id}/compasses/{compass_id}/musicalNotes" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        onclick="cancelTryOut('GETapi-songs--song_id--compasses--compass_id--musicalNotes');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-songs--song_id--compasses--compass_id--musicalNotes"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="GETapi-songs--song_id--compasses--compass_id--musicalNotes" value="1"
                        data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="compass_id"
                        data-endpoint="GETapi-songs--song_id--compasses--compass_id--musicalNotes" value="1"
                        data-component="url">
                    <br>
                    <p>The ID of the compass. Example: <code>1</code></p>
            ...
            <h2 id="notas-musicales-POSTapi-songs--song_id--compasses--compass_id--musicalNotes">Añadir un nueva nota
                musical.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-songs--song_id--compasses--compass_id--musicalNotes" data-method="POST"
                data-path="api/songs/{song_id}/compasses/{compass_id}/musicalNotes" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        onclick="cancelTryOut('POSTapi-songs--song_id--compasses--compass_id--musicalNotes');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        ...
                        value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes" value="1"
                        data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="chord_id"
                        data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes" value="17"
                        data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>string</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <input type="text" style="display: none" name="lyrics"
                        data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                        value="mqeopfuudtdsufvyvddqa" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>boolean</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <label data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                        style="display: none">
                        <input type="radio" name="is_dotted" value="true"
                            data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                            data-component="body">
                        <code>true</code>
                    </label>
                    <label data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                        style="display: none">
                        <input type="radio" name="is_dotted" value="false"
                            data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                            data-component="body">
                        <code>false</code>
                    </label>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <label data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                        style="display: none">
                        <input type="radio" name="is_silence" value="true"
                            data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                            data-component="body">
                        <code>true</code>
                    </label>
                    <label data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                        style="display: none">
                        <input type="radio" name="is_silence" value="false"
                            data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes"
                            data-component="body">
                        <code>false</code>
                    </label>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="rhythmic_figure_id"
                        data-endpoint="POSTapi-songs--song_id--compasses--compass_id--musicalNotes" value="17"
                        data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the rhythmic_figures table. Example: <code>17</code>
                    </p>
                </div>
            </form>

            <h2 id="notas-musicales-GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Mostrar una nota
                musical.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-" data-method="GET"
                data-path="api/songs/{song_id}/compasses/{compass_id}/musicalNotes/{id}" data-authed="0"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        onclick="tryItOut('GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        onclick="cancelTryOut('GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="GETapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        value="application/json" data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
            ...
            <h2 id="notas-musicales-PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Actualizar una
                nota.</h2>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-" data-method="PUT"
                data-path="api/songs/{song_id}/compasses/{compass_id}/musicalNotes/{id}" data-authed="1"
                data-hasfiles="0" data-isarraybody="0" autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        onclick="tryItOut('PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-');">Try it
                        out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        onclick="cancelTryOut('PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>boolean</small>&nbsp;
                    <i>optional</i> &nbsp;
                    <label data-endpoint="PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        style="display: none">
                        <input type="radio" name="is_dotted" value="true"
                            data-endpoint="PUTapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                            data-component="body">
            ...
            <h2 id="notas-musicales-DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-">Eliminar una
                nota musical.</h2>
            ...
            <form id="form-DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-" data-method="DELETE"
                ...
                <h3>
                    ...
                    <button type="button"
                        ...
                        onclick="tryItOut('DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-');">Try
                        it out ⚡
                    </button>
                    <button type="button"
                        style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-canceltryout-DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        onclick="cancelTryOut('DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-');"
                        hidden>Cancel 🛑
                    </button>&nbsp;&nbsp;
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="DELETEapi-songs--song_id--compasses--compass_id--musicalNotes--id-"
                        value="Bearer {YOUR_AUTH_KEY}" data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-POSTapi-songs--song_id--reviews" data-method="POST"
                data-path="api/songs/{song_id}/reviews" data-authed="1" data-hasfiles="0" data-isarraybody="0"
                autocomplete="off"
                ...
                <h3>
                    ...
                    <button type="submit"
                        style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                        id="btn-executetryout-POSTapi-songs--song_id--reviews" data-initial-text="Send Request 💥"
                        data-loading-text="⏱ Sending..." hidden>Send Request 💥
                    </button>
                </h3>
                <p>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="POSTapi-songs--song_id--reviews" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="POSTapi-songs--song_id--reviews" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="POSTapi-songs--song_id--reviews" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
                <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    <small>integer</small>&nbsp;
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="rating"
                        data-endpoint="POSTapi-songs--song_id--reviews" value="5" data-component="body">
                    <br>
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="POSTapi-songs--song_id--reviews" value="17" data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the users table. Example: <code>17</code></p>
                </div>
            </form>
...
You can check the Dev Tools console for debugging information.</code></pre>
            ...
            <form id="form-PUTapi-songs--song_id--reviews--id-" data-method="PUT"
                data-path="api/songs/{song_id}/reviews/{id}" data-authed="1" data-hasfiles="0"
                data-isarraybody="0" autocomplete="off"
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Authorization" class="auth-value"
                        data-endpoint="PUTapi-songs--song_id--reviews--id-" value="Bearer {YOUR_AUTH_KEY}"
                        data-component="header">
                    <br>
                    <p>Example: <code>Bearer {YOUR_AUTH_KEY}</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="text" style="display: none" name="Content-Type"
                        data-endpoint="PUTapi-songs--song_id--reviews--id-" value="application/json"
                        data-component="header">
                    <br>
                    <p>Example: <code>application/json</code></p>
                </div>
                ...
                <div style="padding-left: 28px; clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="song_id"
                        data-endpoint="PUTapi-songs--song_id--reviews--id-" value="1" data-component="url">
                    <br>
                    <p>The ID of the song. Example: <code>1</code></p>
                </div>
                <div style="padding-left: 28px; clear: unset;">
                ...
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="rating"
                        data-endpoint="PUTapi-songs--song_id--reviews--id-" value="5" data-component="body">
                    <br>
                    <p>Must be at least 1. Must not be greater than 5. Example: <code>5</code></p>
                </div>
                <div style=" padding-left: 28px;  clear: unset;">
                    ...
                    &nbsp;
                    <input type="number" style="display: none" step="any" name="user_id"
                        data-endpoint="PUTapi-songs--song_id--reviews--id-" value="17" data-component="body">
                    <br>
                    <p>The <code>id</code> of an existing record in the users table. Example: <code>17</code></p>
                </div>
            </form>
